...
@property_router.post('/create_new_property', response_model=PropertyList)
...
@property_router.put('/update_property_details', response_model=PropertyList)
...
def get_all_properties():
    all_properties = collection.find({})
    property_list = []
    for prop in all_properties:
        prop['_id'] = str(prop['_id']) 
        prop['id'] = prop.pop('_id')
        property_list.append(PropertyDetail(**prop))
